...
/* package enyo-tool-server-0.1.0.0 */
#ifndef VERSION_enyo_tool_server
#define VERSION_enyo_tool_server "0.1.0.0"
#endif /* VERSION_enyo_tool_server */
#ifndef MIN_VERSION_enyo_tool_server
#define MIN_VERSION_enyo_tool_server(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_enyo_tool_server */
...
#define CURRENT_COMPONENT_ID "enyo-tool-server-0.1.0.0-inplace-enyo-tool-server"
